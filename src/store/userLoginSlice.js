...
// make api call 
export const userLoginLifeCycle = createAsyncThunk('signin', async (userCredObj, { rejectWithValue }) => {

        let res = await axios.post("http://localhost:4000/user/signin", userCredObj)
...
export const userLoginSlice = createSlice({
    name: "signin",
    initialState: { userObj: {}, isPending: false, isSuccess: false, isError: false, errorMessage: "" },
    reducers: {
